...
const Index = {
  ...
  updateLanguages: (languageSource) => {
    ...
    document.getElementById("stagestatus").innerText = languageSource.stagestatus;
    document.getElementById("current_stage").innerText = languageSource.current_stage;
    document.getElementById("error_view_text").innerText = languageSource.error_view_text;
    document.getElementById("spinner_mining_text").innerText = languageSource.spinner_mining_text;
